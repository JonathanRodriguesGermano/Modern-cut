  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: cn(
          "flex items-center gap-3 absolute right-0 h-7 top-0",
          defaultClassNames.nav
        ),
        button_previous: cn(
          buttonVariants({ variant: buttonVariant }),
          "size-(--cell-size) aria-disabled:opacity-50 p-0 select-none static border",
        ...
        month_caption: cn(
          "flex items-center justify-start pt-1 pl-2 h-7 w-full",
        ...
        caption_label: cn(
          "select-none font-medium capitalize font-bold",
          captionLayout === "label"
            ? "text-sm"
